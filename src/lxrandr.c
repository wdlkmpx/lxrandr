 ...
 *      Copyright (C) 2016 Thomas Erbesdobler <t.erbesdobler@team103.com>
 *
...
//    gtk_about_dialog_set_url_hook( open_url, NULL, NULL);
    ...
    gtk_about_dialog_set_program_name ( (GtkAboutDialog*)about_dlg, "LXRandR" );
    gtk_about_dialog_set_logo_icon_name( (GtkAboutDialog*)about_dlg, "video-display" );
    gtk_about_dialog_set_copyright ( (GtkAboutDialog*)about_dlg, "Copyright (C) 2008-2020" );
